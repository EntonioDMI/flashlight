...
// Flashlight — копия ванильного entity.vsh (26.1.2) + варьинг view-space позиции
// для конусного света в фрагментнике.
...
out vec2 texCoord0;
out vec3 flViewPos; // Flashlight: позиция вершины в view-space
